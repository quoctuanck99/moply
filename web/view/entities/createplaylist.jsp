<%-- 
    ...
    Created on : Jul 24, 2019, 11:11:47 PM
    Author     : quoct
--%>
...
<html>
    <jsp:include page="../../template/nagivator/nagivatorBar.jsp"></jsp:include>
        <head>
            ...
            <title>Create new playlist | Moply</title>
        </head>           
        ...
        <body>
            <div class="main_container">
                <div class="content">
                    <div class="wrap">
                        <div class="page_title"><h2><b>Create new playlist</b></h2></div>
                        <hr>
                        <br>
                        <form class="add_form" method="post" action="createplaylist">
                            <table>
                                <tr>
                                    <td>Playlist name:</td>
